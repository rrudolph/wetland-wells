...
inPath = r"C:\Temp\Yellowstone wetland\PilotWells_YELL NR wells\Site Data"
outPath = r"C:\Temp\Yellowstone wetland\PilotWells_YELL NR wells\Processed Data"
searchFiles = (".csv") 
...
for file in files:
	if "BaroMerge" in file:
		...
		outFile = outPath + os.sep + well + ".csv"
